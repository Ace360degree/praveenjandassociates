...
export const HEADER_MENU: NavEntry[] = [
  ...
  {
    title: "GST",
    href: "/gst-registration-return-filing-services",
    groups: [
      {
        title: "GST Services",
        href: "/gst-registration-return-filing-services",
      ...
      },
      {
        ...
        href: "/gst-registration-return-filing-services",
        items: [
          { title: "GSTR-1 & 3B", href: "/gst/gst-return-filing-gstr1-gstr3b-india" },
          { title: "Quarterly GST Return", href: "/gst/quarterly-gst-return-qrmp-gstr1-3b-india" },
          { title: "GSTR-9 Annual", href: "/gst/gstr9-annual-gst-return-filing-india" },
          { title: "GSTR-9C Audit", href: "/gst/gstr9c-gst-audit-reconciliation-india" },
          { title: "GSTR-10 Final", href: "/gst/gstr10-final-return-gst-india" },
        ],
      },
      {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Share Certificate", href: "/issue-of-share-certificate-sh1" },
          { title: "Strike Off (Company / LLP)", href: "/strike-off-company-llp" },
        ],
      },
      {
        title: "Loan Charge",
        href: "/loan-creation-modification-of-charge",
        items: [
          { title: "Creation & Modification", href: "/loan-creation-modification-of-charge" },
          { title: "Modification", href: "/modification-of-charge-roc-mca" },
