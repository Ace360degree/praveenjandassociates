...
export const Route = createFileRoute("/accounting-review-visits-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("accounting-review-visits-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/accounting-review-visits-services` },
      ],
      links: [{ rel: "canonical", href: `/accounting-review-visits-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Ensure your financial records are accurate, compliant and audit-ready.</h2>
