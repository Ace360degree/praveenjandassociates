  ...
  return (
    <section className="py-16 bg-gradient-to-br from-brand to-brand-dark text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Ready to register the right way?</h2>
...
function Related({ currentSlug }: { currentSlug: string }) {
  ...
  return (
    <section className="py-14 bg-muted/30">
      <div className="container mx-auto px-4">
        <h2 className="font-display text-xl sm:text-2xl md:text-3xl font-bold text-ink break-words text-center">Explore More Registration Services</h2>
