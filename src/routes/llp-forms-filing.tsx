...
export const Route = createFileRoute("/llp-forms-filing")({
  loader: () => {
    const s = getMcaServiceBySlug("llp-forms-filing");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          File Your LLP Forms Today. Ensure smooth compliance and avoid penalties.
        </h2>
