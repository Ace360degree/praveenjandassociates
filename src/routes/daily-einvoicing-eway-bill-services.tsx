...
export const Route = createFileRoute("/daily-einvoicing-eway-bill-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("daily-einvoicing-eway-bill-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/daily-einvoicing-eway-bill-services` },
      ],
      links: [{ rel: "canonical", href: `/daily-einvoicing-eway-bill-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Ensure smooth business operations with proper GST compliance.</h2>
