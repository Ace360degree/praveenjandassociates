...
export const Route = createFileRoute("/strike-off-company-llp")({
  loader: () => {
    const s = getMcaServiceBySlug("strike-off-company-llp");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Close Your Company / LLP Today. Avoid compliance burden and shut down your entity
          smoothly.
        </h2>
