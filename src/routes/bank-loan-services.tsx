...
export const Route = createFileRoute("/bank-loan-services")({
  loader: () => {
    const s = getBankLoanServiceBySlug("bank-loan-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/bank-loan-services` },
      ],
      links: [{ rel: "canonical", href: `/bank-loan-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Get expert guidance to secure the right loan with better approval chances.</h2>
