...
function FinalCTA({ s }: { s: NonNullable<ReturnType<typeof getTdsServiceBySlug>> }) {
  return (
    <section className="py-16 bg-gradient-to-br from-brand to-brand/80 text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        ...
        <p className="mt-3 text-white/90">CA-led TDS & TCS support — fast, accurate, compliant.</p>
