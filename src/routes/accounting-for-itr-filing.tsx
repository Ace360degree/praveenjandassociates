...
export const Route = createFileRoute("/accounting-for-itr-filing")({
  loader: () => {
    const s = getAccountingServiceBySlug("accounting-for-itr-filing");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/accounting-for-itr-filing` },
      ],
      links: [{ rel: "canonical", href: `/accounting-for-itr-filing` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Avoid errors and file your ITR with confidence.</h2>
