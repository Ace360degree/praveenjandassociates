...
export const Route = createFileRoute("/aoc-4-filing-private-limited")({
  loader: () => {
    const s = getMcaServiceBySlug("aoc-4-filing-private-limited");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          File Your AOC-4 Today – Avoid Heavy Penalties. Get expert CA support for smooth ROC
          compliance.
        </h2>
