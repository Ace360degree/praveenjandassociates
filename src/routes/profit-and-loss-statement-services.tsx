...
export const Route = createFileRoute("/profit-and-loss-statement-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("profit-and-loss-statement-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/profit-and-loss-statement-services` },
      ],
      links: [{ rel: "canonical", href: `/profit-and-loss-statement-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Track your business performance and make better financial decisions.</h2>
