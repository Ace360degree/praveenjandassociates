...
export const Route = createFileRoute("/startup-outsourcing-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("startup-outsourcing-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/startup-outsourcing-services` },
      ],
      links: [{ rel: "canonical", href: `/startup-outsourcing-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Focus on building your startup while we handle your finances and compliance.</h2>
