...
const FAQS = [
  {
    ...
    a: "A sole proprietorship is a business owned and managed by one individual with full control over operations and profits.",
  },
  {
    q: "Is registration mandatory?",
    a: "There is no single mandatory registration for proprietorship itself, but GST, MSME, Shop & Establishment or other licences may be needed based on business activity.",
  },
  {
    q: "How long does setup take?",
    a: "Usually only a few days, depending on the registrations required and document readiness.",
  },
  {
    q: "Do I need GST?",
    a: "GST depends on turnover, business nature and whether interstate supply is involved.",
  },
  {
    q: "Can CA handle everything?",
    a: "Yes. We provide complete end-to-end support for registrations, documentation and compliance setup.",
  },
];
...
const INCLUDED = [
  {
    ...
    text: "If applicable for your business model and turnover.",
  },
  {
    icon: BadgeCheck,
    title: "MSME (Udyam)",
    text: "For scheme access, recognition and business benefits.",
  },
  {
    icon: Building2,
    title: "Shop & Establishment",
    text: "State-level registration where applicable.",
  },
  {
    icon: FileText,
    title: "Bank Account Guidance",
    text: "Support for opening and setting up a current account.",
  },
  {
    icon: ShieldCheck,
    title: "Basic Compliance Setup",
    text: "A simple roadmap for day-one compliance.",
  },
];
...
const CHALLENGES = [
  "Confusion about registrations and licences",
  "Delays in GST or approvals",
  "Incorrect documentation",
  "Difficulty opening a current account",
...
const PROCESS = [
  ...
  "Apply for GST, MSME and licences",
...
export const Route = createFileRoute("/sole-proprietorship-registration-services")({
  head: () => ({
    meta: [
      { title: "Sole Proprietorship Registration in India | Praveen J & Associates" },
      {
        name: "description",
        content:
          "Start your sole proprietorship business in India with expert CA support for GST, MSME, Shop & Establishment and basic compliance setup.",
      },
      {
        property: "og:title",
        content: "Sole Proprietorship Registration with Expert CA Support",
      },
      {
        property: "og:description",
        content:
          "Complete sole proprietorship setup support for freelancers, traders, shops and small businesses.",
      },
      { property: "og:url", content: "/sole-proprietorship-registration-services" },
    ],
    links: [{ rel: "canonical", href: "/sole-proprietorship-registration-services" }],
    scripts: [
      {
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          areaServed: "IN",
          description:
            "Sole proprietorship setup, GST, MSME and Shop & Establishment support with expert CA guidance.",
        }),
      },
    ],
  }),
  component: SoleProprietorshipRegistrationPage,
});

function SoleProprietorshipRegistrationPage() {
  return (
  ...
  return (
    <nav className="border-b bg-muted/30" aria-label="Breadcrumb">
      <ol className="container mx-auto flex flex-wrap items-center gap-2 px-4 py-3 text-sm text-muted-foreground">
        ...
        <ChevronRight className="h-3 w-3" />
        <li className="font-medium text-ink">Sole Proprietorship Registration</li>
      </ol>
    </nav>
  );
}
      ...
      <div className="container mx-auto grid gap-10 px-4 py-12 relative lg:grid-cols-2 lg:items-center lg:py-20">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
            <Sparkles className="h-3.5 w-3.5" /> Simple Business Setup
          </span>
          <h1 className="mt-4 font-display text-3xl font-bold leading-tight text-ink md:text-5xl">
            Sole Proprietorship Registration in India - Easy Business Setup with CA Support
          </h1>
          <p className="mt-3 max-w-xl text-lg text-muted-foreground">
            Start your business quickly with the simplest setup in India. A sole proprietorship is
            the fastest and most affordable way to begin.
          </p>
          <p className="mt-2 text-muted-foreground">
            Get complete support for GST, MSME and business registration with expert CA guidance.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            >
              Start Proprietorship Registration <ArrowRight className="h-4 w-4" />
            </a>
            <a
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            ...
            <span className="flex items-center gap-1">
              <BadgeCheck className="h-4 w-4 text-brand" /> Business Setup
            </span>
          </div>
        </div>
        ...
        <div id="lead" className="rounded-3xl border bg-white p-6 shadow-xl lg:p-8">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold text-ink">
              Free Proprietorship Consultation
            </h2>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              const msg = `Hi, I need help with sole proprietorship registration.%0AName: ${form.name}%0APhone: ${form.phone}%0AEmail: ${form.email}`;
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
              <Store className="h-3.5 w-3.5" /> About Sole Proprietorship
            </div>
            <h2 className="mt-4 font-display text-2xl font-bold text-ink md:text-3xl">
              What is a sole proprietorship?
            </h2>
            <p className="mt-4 text-muted-foreground">
              A sole proprietorship is a business owned and managed by one individual with full
              control over operations and profits. It is ideal for small businesses, freelancers,
              consultants, local shops and service providers.
            </p>
            <p className="mt-3 text-muted-foreground">
              It offers quick setup, low cost and minimal compliance, making it one of the simplest
              ways to begin a business in India.
            </p>
          </div>
    ...
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          Everything you need to start your business legally and smoothly.
        </p>
    ...
    <section className="bg-white py-14">
      <div className="container mx-auto max-w-5xl px-4">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <div className="rounded-2xl border bg-gradient-to-br from-white to-brand/5 p-6 shadow-sm">
            <h3 className="flex items-center gap-2 font-display text-xl font-bold text-ink">
              <BadgeCheck className="h-5 w-5 text-brand" /> Perfect for
            </h3>
            <div className="mt-4 grid gap-3">
              {[
                "Freelancers and consultants",
    ...
    <section className="bg-white py-14">
      <div className="container mx-auto max-w-5xl px-4">
        <div className="rounded-3xl border bg-gradient-to-br from-white to-brand/5 p-6 shadow-sm md:p-8">
          ...
          <p className="mt-2 text-center text-muted-foreground">
            We make your proprietorship setup clear, quick and fully supported.
          </p>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              "Understanding the exact registrations you need",
              "Preparing and checking every document",
              "Supporting you until the setup is complete",
            ].map((item) => (
  ...
  return (
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          Simple, fast and hassle-free execution.
        </p>
...
function TrustSection() {
  const reviews = [
    "Started my business easily with their help.",
    "Very smooth GST and MSME registration.",
    "Great support for small business setup.",
  ];
    ...
    <section className="bg-white py-14">
      <div className="container mx-auto max-w-5xl px-4">
        <div className="text-center">
          ...
          <h2 className="font-display text-2xl font-bold text-ink md:text-3xl">
            Trusted Sole Proprietorship Support
          </h2>
          <p className="mt-2 text-muted-foreground">
            Clients trust us for proprietorship setup and compliance guidance.
          </p>
        </div>
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {reviews.map((review) => (
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <h2 className="mt-6 max-w-4xl font-display text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
            ...
            <br />
            with a simple proprietorship setup
          </h2>
          <p className="mt-6 max-w-2xl text-base font-medium text-white/92 sm:text-lg">
            Start your business today with a simple and hassle-free setup.
          </p>
