...
export const Route = createFileRoute("/balance-sheet-preparation-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("balance-sheet-preparation-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/balance-sheet-preparation-services` },
      ],
      links: [{ rel: "canonical", href: `/balance-sheet-preparation-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Get accurate financial statements for better decisions and compliance.</h2>
