...
export const Route = createFileRoute("/itr-balance-sheet-preparation-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("itr-balance-sheet-preparation-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/itr-balance-sheet-preparation-services` },
      ],
      links: [{ rel: "canonical", href: `/itr-balance-sheet-preparation-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">File your ITR with confidence using accurate financial statements.</h2>
