...
export const Route = createFileRoute("/mca-roc-filing-services-india")({
  loader: () => {
    const s = getMcaServiceBySlug("mca-roc-filing-services-india");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/mca-roc-filing-services-india` },
      ],
      links: [{ rel: "canonical", href: `/mca-roc-filing-services-india` }],
      scripts: [
        {
