...
export const Route = createFileRoute("/llp-agreement-changes")({
  loader: () => {
    const s = getMcaServiceBySlug("llp-agreement-changes");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Modify Your LLP Agreement Today. Ensure compliance and clarity with expert assistance.
        </h2>
