...
export const Route = createFileRoute("/project-report-for-bank-loan")({
  loader: () => {
    const s = getBankLoanServiceBySlug("project-report-for-bank-loan");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/project-report-for-bank-loan` },
      ],
      links: [{ rel: "canonical", href: `/project-report-for-bank-loan` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Increase your chances of loan approval with a professionally prepared project report.</h2>
