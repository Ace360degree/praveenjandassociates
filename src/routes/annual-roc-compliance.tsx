...
export const Route = createFileRoute("/annual-roc-compliance")({
  loader: () => {
    const s = getMcaServiceBySlug("annual-roc-compliance");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Complete Your Annual ROC Compliance Today. Avoid penalties and keep your company active.
        </h2>
