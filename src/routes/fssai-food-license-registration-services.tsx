...
const FAQS = [
  {
    q: "Is FSSAI license mandatory?",
    a: "Yes, it is mandatory for all food-related businesses operating in India.",
  },
  {
    q: "Which license do I need?",
    a: "It depends on your business size, turnover and activity. We help identify the correct category.",
  },
  {
    q: "Can home kitchens apply?",
    a: "Yes. Home kitchens can apply for basic registration, subject to eligibility.",
  },
  {
    q: "How long does it take?",
    a: "Usually a few days to a few weeks, depending on the license category and documentation.",
  },
  {
    q: "Can CA handle full process?",
    a: "Yes. We provide complete support from eligibility to filing, follow-up and approval.",
  },
];
...
const BUSINESS_TYPES = [
  {
    ...
    points: ["Small businesses", "Home kitchens", "Low turnover food businesses"],
  },
  {
    icon: Store,
    title: "State License",
    points: ["Medium-sized businesses", "Restaurants and cafes", "Cloud kitchens"],
  },
  {
    icon: Building2,
    title: "Central License",
    points: ["Large businesses", "Manufacturers", "Exporters"],
  },
];
...
const BENEFITS = [
  ...
  "Avoids penalties and closure",
];

const PROBLEMS = [
  "Confusion in license type",
  "Incorrect application",
  "Rejection due to documentation",
  "Delay in approval",
  "Lack of compliance knowledge",
];

const HELP = [
  "Identify correct FSSAI category",
...
const DOCUMENTS = [
  ...
  "Address proof",
  "Business details",
  "Kitchen or shop details",
  "Supporting documents",
];

export const Route = createFileRoute("/fssai-food-license-registration-services")({
  head: () => ({
    meta: [
      { title: "FSSAI Food License Registration in India | Praveen J & Associates" },
      {
        name: "description",
        content:
          "Apply for FSSAI food license registration in India with expert CA support for basic, state and central licenses.",
      },
      {
        property: "og:title",
        content: "FSSAI Food License Registration with Expert CA Support",
      },
      {
        property: "og:description",
        content:
          "Complete FSSAI registration support for home kitchens, cloud kitchens, restaurants and food businesses.",
      },
      { property: "og:url", content: "/fssai-food-license-registration-services" },
    ],
    links: [{ rel: "canonical", href: "/fssai-food-license-registration-services" }],
    scripts: [
      {
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          name: "FSSAI Food License Registration Services",
          provider: { "@type": "Organization", name: "Praveen J & Associates" },
          areaServed: "IN",
          description:
            "FSSAI food license registration and compliance support for all food businesses.",
        }),
      },
    ],
  }),
  component: FssaiFoodLicenseRegistrationPage,
});

function FssaiFoodLicenseRegistrationPage() {
  return (
  ...
  return (
    <nav className="border-b bg-muted/30" aria-label="Breadcrumb">
      <ol className="container mx-auto flex flex-wrap items-center gap-2 px-4 py-3 text-sm text-muted-foreground">
        ...
        <ChevronRight className="h-3 w-3" />
        <li className="font-medium text-ink">FSSAI Food License Registration</li>
      </ol>
    </nav>
  );
}
      ...
      <div className="container mx-auto grid gap-10 px-4 py-12 relative lg:grid-cols-2 lg:items-center lg:py-20">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
            <Sparkles className="h-3.5 w-3.5" /> Food License Services
          </span>
          <h1 className="mt-4 font-display text-3xl font-bold leading-tight text-ink md:text-5xl">
            FSSAI Food License Registration in India - Food License Services with CA Support
          </h1>
          <p className="mt-3 max-w-xl text-lg text-muted-foreground">
            Starting a food business or cloud kitchen? Get your FSSAI Food License and operate
            legally with confidence.
          </p>
          <p className="mt-2 text-muted-foreground">
            Expert CA support for FSSAI registration, license approval and compliance.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            >
              Apply for FSSAI License <ArrowRight className="h-4 w-4" />
            </a>
            <a
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            ...
            <span className="flex items-center gap-1">
              <BadgeCheck className="h-4 w-4 text-brand" /> Food Compliance
            </span>
          </div>
        </div>
        ...
        <div id="lead" className="rounded-3xl border bg-white p-6 shadow-xl lg:p-8">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold text-ink">Free FSSAI Consultation</h2>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              const msg = `Hi, I need help with FSSAI registration.%0AName: ${form.name}%0APhone: ${form.phone}%0AEmail: ${form.email}`;
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
          <p className="text-sm leading-relaxed text-muted-foreground">
            The FSSAI (Food Safety and Standards Authority of India) License is mandatory for
            restaurants, cafes, cloud kitchens, home-based food businesses, food manufacturers and
            traders.
          </p>
    ...
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-6 text-center text-sm font-medium text-ink">
          We help you choose the correct license type.
        </p>
      </div>
    </section>
  );
    ...
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          Mistakes can delay your business launch.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border bg-gradient-to-br from-white to-brand/5 p-6 shadow-sm">
            ...
            <div className="mt-4 grid gap-3">
              {[
                "Correct FSSAI category guidance",
                "Complete application filing",
                "Documentation support",
                "Approval follow-up",
                "Compliance guidance",
  ...
  return (
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-2 text-center text-muted-foreground">Fast and smooth execution.</p>
...
function TrustSection() {
  const reviews = [
    "Got my FSSAI license quickly for my cloud kitchen.",
    "Very smooth and professional process.",
    "Helped me start my food business legally.",
  ];
      ...
      <div className="container mx-auto max-w-5xl px-4">
        <div className="text-center">
          ...
          <h2 className="font-display text-2xl font-bold text-ink md:text-3xl">
            Trusted Food License Support
          </h2>
          <p className="mt-2 text-muted-foreground">
            Clients trust us for fast and reliable FSSAI registration.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <h2 className="mt-6 max-w-4xl font-display text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
            Start your food business legally
            <br />
            with FSSAI registration
          </h2>
          <p className="mt-6 max-w-2xl text-base font-medium text-white/92 sm:text-lg">
            Food business compliance done right keeps your operations legal and your customers
            confident.
          </p>
