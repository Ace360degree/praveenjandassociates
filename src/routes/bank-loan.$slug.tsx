  ...
  return (
    <section className="py-14 bg-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-ink">Trusted by Businesses & Individuals</h2>
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-brand to-brand/80 text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-3xl md:text-4xl font-bold">Ready to strengthen your loan application?</h2>
...
function RelatedServices({ currentSlug }: { currentSlug: string }) {
  ...
  return (
    <section className="py-14 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-ink text-center">Explore More Bank Loan Services</h2>
...
function StickyMobileCTA({ cta }: { cta: string }) {
  return (
    <div className="lg:hidden fixed bottom-0 inset-x-0 z-30 bg-white border-t shadow-2xl p-3 flex gap-2">
      <a href="tel:+919999999999" className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-muted text-ink px-4 py-3 font-semibold text-sm">
