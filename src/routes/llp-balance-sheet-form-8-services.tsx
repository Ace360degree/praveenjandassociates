...
export const Route = createFileRoute("/llp-balance-sheet-form-8-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("llp-balance-sheet-form-8-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/llp-balance-sheet-form-8-services` },
      ],
      links: [{ rel: "canonical", href: `/llp-balance-sheet-form-8-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Stay compliant and avoid penalties with expert LLP filing support.</h2>
