...
export const Route = createFileRoute("/adt-1-filing-for-auditor")({
  loader: () => {
    const s = getMcaServiceBySlug("adt-1-filing-for-auditor");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          File ADT-1 Today – Stay Fully Compliant. Ensure proper auditor appointment without delays.
        </h2>
