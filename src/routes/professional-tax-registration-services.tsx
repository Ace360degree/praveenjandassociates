...
const FAQS = [
  {
    ...
    a: "Professional Tax is a state-level tax on income from profession, employment or business in applicable states.",
  },
  {
    q: "What are PTRC and PTEC?",
    a: "PTRC is for employers to deduct tax from employee salaries, while PTEC is for business owners and professionals to pay tax on their own income.",
  },
  {
    q: "Is PT mandatory?",
    a: "Yes, in states where Professional Tax applies, registration and filing are mandatory.",
  },
  {
    q: "What happens if not registered?",
    a: "Non-registration can lead to penalties, notices and compliance issues.",
  },
  {
    q: "Can CA handle registration and filing?",
    a: "Yes. We provide complete support for PT registration, filing and ongoing compliance.",
  },
];

const INCLUDES = [
  "PTRC registration support",
  "PTEC registration support",
  "Documentation and filing support",
  "Compliance setup guidance",
  "Ongoing CA assistance",
];
...
const BENEFITS = [
  ...
  "Needed for audits and filings",
  "Helps maintain compliance discipline",
];
...
const HELP = [
  "Identify correct PT registration",
...
const PROCESS = [
  ...
  "Identify PTRC/PTEC requirement",
  "Prepare documents",
...
const AUDIENCE = [
  ...
  "Companies and LLPs",
  "Anyone liable for professional tax in India",
];
...
export const Route = createFileRoute("/professional-tax-registration-services")({
  head: () => ({
    meta: [
      { title: "Professional Tax Registration in India | Praveen J & Associates" },
      {
        name: "description",
        content:
          "Apply for Professional Tax registration in India with expert CA support for PTRC, PTEC, filing and compliance.",
      },
      {
        property: "og:title",
        content: "Professional Tax Registration with Expert CA Support",
      },
      {
        property: "og:description",
        content:
          "Complete Professional Tax registration support for PTRC, PTEC and ongoing compliance.",
      },
      { property: "og:url", content: "/professional-tax-registration-services" },
    ],
    links: [{ rel: "canonical", href: "/professional-tax-registration-services" }],
    scripts: [
      {
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          areaServed: "IN",
          description:
            "Professional Tax registration, PTRC, PTEC and compliance support with expert CA guidance.",
        }),
      },
    ],
  }),
  component: ProfessionalTaxRegistrationPage,
});

function ProfessionalTaxRegistrationPage() {
  return (
  ...
  return (
    <nav className="border-b bg-muted/30" aria-label="Breadcrumb">
      <ol className="container mx-auto flex flex-wrap items-center gap-2 px-4 py-3 text-sm text-muted-foreground">
        ...
        <ChevronRight className="h-3 w-3" />
        <li className="font-medium text-ink">Professional Tax Registration</li>
      </ol>
    </nav>
  );
}
      ...
      <div className="container mx-auto grid gap-10 px-4 py-12 relative lg:grid-cols-2 lg:items-center lg:py-20">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
            <Sparkles className="h-3.5 w-3.5" /> PT Compliance
          </span>
          <h1 className="mt-4 font-display text-3xl font-bold leading-tight text-ink md:text-5xl">
            Professional Tax Registration in India - PTRC & PTEC Registration with CA Support
          </h1>
          <p className="mt-3 max-w-xl text-lg text-muted-foreground">
            Running a business or earning professional income? Get your Professional Tax (PT)
            registration done and stay fully compliant.
          </p>
          <p className="mt-2 text-muted-foreground">
            Expert CA support for PTRC, PTEC registration and compliance.
          </p>
          <div className="mt-6 flex flex-col sm:flex-row flex-wrap gap-3">
            ...
            >
              Apply for Professional Tax Registration <ArrowRight className="h-4 w-4" />
            </a>
            <a
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            ...
            <span className="flex items-center gap-1">
              <BadgeCheck className="h-4 w-4 text-brand" /> PT Compliance
            </span>
          </div>
        </div>
        ...
        <div id="lead" className="rounded-3xl border bg-white p-6 shadow-xl lg:p-8">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold text-ink">Free PT Consultation</h2>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              const msg = `Hi, I need help with Professional Tax registration.%0AName: ${form.name}%0APhone: ${form.phone}%0AEmail: ${form.email}`;
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
          <p className="text-sm leading-relaxed text-muted-foreground">
            Professional Tax (PT) is a state-level tax applicable to businesses, employers,
            professionals and freelancers. It is mandatory in states like Maharashtra and requires
            proper registration and filing.
          </p>
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>Required for employers</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                <span>Deduct PT from employee salaries</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                <span>Monthly or quarterly filing</span>
              </li>
            </ul>
          </div>
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                <span>Required for business owners and professionals</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                <span>Pay tax on your own income</span>
              </li>
            </ul>
          </div>
        </div>
        <p className="mt-6 text-center text-sm font-medium text-ink">
          Both registrations may be required depending on your business structure.
        </p>
      </div>
    </section>
  );
...
function BenefitsSection() {
  return (
    <section className="bg-white py-14">
      <div className="container mx-auto max-w-5xl px-4">
        <h2 className="text-center font-display text-2xl font-bold text-ink md:text-3xl">
          Why Professional Tax Is Important
        </h2>
    ...
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          These issues can lead to unnecessary fines.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border bg-gradient-to-br from-white to-brand/5 p-6 shadow-sm">
            ...
            <div className="mt-4 grid gap-3">
              {[
                "Correct PT registration guidance",
                "Complete application and documentation",
                "Quick registration processing",
                "Filing and compliance support",
                "Ongoing CA assistance",
...
function TrustSection() {
  const reviews = [
    "Got PTRC and PTEC registration quickly.",
    "Very helpful in understanding compliance.",
    ...
    <section className="bg-muted/30 py-14">
      <div className="container mx-auto max-w-5xl px-4">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Clients trust us for Professional Tax registration and compliance.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <h2 className="mt-6 max-w-4xl font-display text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
            ...
            <br />
            with Professional Tax registration
          </h2>
          <p className="mt-6 max-w-2xl text-base font-medium text-white/92 sm:text-lg">
            Get PTRC and PTEC support so your business stays compliant without the stress.
          </p>
