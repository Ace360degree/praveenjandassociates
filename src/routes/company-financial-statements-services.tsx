...
export const Route = createFileRoute("/company-financial-statements-services")({
  loader: () => {
    const s = getAccountingServiceBySlug("company-financial-statements-services");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/company-financial-statements-services` },
      ],
      links: [{ rel: "canonical", href: `/company-financial-statements-services` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Ensure your company financials are compliant, accurate and audit-ready.</h2>
