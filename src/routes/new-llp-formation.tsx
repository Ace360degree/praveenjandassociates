...
export const Route = createFileRoute("/new-llp-formation")({
  loader: () => {
    const s = getMcaServiceBySlug("new-llp-formation");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Start Your New LLP Today. Get expert CA support and launch your business with confidence.
        </h2>
