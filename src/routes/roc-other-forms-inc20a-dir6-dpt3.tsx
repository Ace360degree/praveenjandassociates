...
export const Route = createFileRoute("/roc-other-forms-inc20a-dir6-dpt3")({
  loader: () => {
    const s = getMcaServiceBySlug("roc-other-forms-inc20a-dir6-dpt3");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          File Your ROC Forms Today. Stay compliant and avoid penalties with expert support.
        </h2>
