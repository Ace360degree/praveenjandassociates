...
export const Route = createFileRoute("/three-year-balance-sheet")({
  loader: () => {
    const s = getBankLoanServiceBySlug("three-year-balance-sheet");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/three-year-balance-sheet` },
      ],
      links: [{ rel: "canonical", href: `/three-year-balance-sheet` }],
      scripts: [
        {
  ...
  return (
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">Strengthen your loan application with professionally prepared financial statements.</h2>
