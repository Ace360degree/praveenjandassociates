...
export const Route = createFileRoute("/loan-creation-modification-of-charge")({
  loader: () => {
    const s = getMcaServiceBySlug("loan-creation-modification-of-charge");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Register or Modify Your Loan Charge Today. Ensure legal protection and compliance for your
          financing.
        </h2>
