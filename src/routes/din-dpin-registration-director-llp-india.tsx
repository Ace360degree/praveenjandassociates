...
export const Route = createFileRoute("/din-dpin-registration-director-llp-india")({
  loader: () => {
    const s = getMcaServiceBySlug("din-dpin-registration-director-llp-india");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Avoid penalties and keep your company compliant with ROC filing.
        </h2>
