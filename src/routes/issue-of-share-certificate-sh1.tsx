...
export const Route = createFileRoute("/issue-of-share-certificate-sh1")({
  loader: () => {
    const s = getMcaServiceBySlug("issue-of-share-certificate-sh1");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Issue Your Share Certificates Today. Ensure compliance and proper ownership documentation.
        </h2>
