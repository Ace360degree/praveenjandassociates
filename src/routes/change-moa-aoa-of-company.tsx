...
export const Route = createFileRoute("/change-moa-aoa-of-company")({
  loader: () => {
    const s = getMcaServiceBySlug("change-moa-aoa-of-company");
    if (!s) throw notFound();
    return s;
  },
  head: ({ loaderData }) => {
    ...
    <section className="py-16 bg-brand text-white">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold break-words">
          Update Your MOA & AOA Today. Expand and align your business with expert legal support.
        </h2>
